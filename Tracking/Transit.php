    ...
    <div class="container-fluid">
        <div class="row">
            <div id="container">
                <div class="row">
                    <div class="col-md-4">
                        <img src="Assets/Food_Transpo_Backgrounds-01.png" class="headimg">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="customRadio1" value="75" name="options">
                                <label class="custom-control-label" for="customRadio1">Public Transit</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="customRadio2">Biking/Walking</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingThree" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="customRadio3" data-toggle="collapse" data-target="#collapsibleNavbar">Carpool</label>
                            </div>
                        </div>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <label id="label" class="custom-control-label" for="customRadio4">2 People</label>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="customRadio5" value="50" name="options">
                                            <label id="label" class="custom-control-label" for="customRadio5">3-4 People</label>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="customRadio6" value="75" name="options">
                                            <label id="label" class="custom-control-label" for="customRadio6">5+ People</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col" id="leftborder">
                ...
                <a class="btn btn-success btn-block" role="button" href="../Progress/progressredirect.php">Progress</a>
            </div>
...
<?php
				if (isset($_SESSION["username"])){
                                ...
                                $Points = $rs['Points'];
                                $Home = $rs['contribHome'];
                                $Transit = "SELECT contribTransit FROM contributions WHERE username='".$_SESSION["username"]."'";
                                $Food = $rs['contribFood'];
                                ...
                                if (isset($_POST['submit'])){
                                    if (isset($_POST['options'])){
                                        ...
                                        $sql2 = "UPDATE user SET Points = $newVal WHERE username='".$_SESSION["username"]."';
                                                ...
                                                VALUES ('".$_SESSION["username"]."', '$contrib', $Home, $newCount, $Food, '$date' );";
